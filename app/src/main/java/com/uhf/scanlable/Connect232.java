...
public class Connect232 extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			txtDevAddr = (EditText) findViewById(R.id.devAddr);
			...
			mConectButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						if(txtDevAddr.getText()==null || txtDevAddr.getText().length()==0)return;
						try{
							ComAddr = (byte)(int)Integer.valueOf(txtDevAddr.getText().toString());
						}catch(Exception ex)
						{}
